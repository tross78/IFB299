...
<div class="panel panel-primary">
  ...
  <h4>Enrolment Details</h4>
	...
	<thead>
            <tr>
              <td><span class="label label-warning arrowed-right">9am</span></td>
              <td><?php echo h($enrolment['Enrolment']['class_one']); ?></td>
            </tr>
        </thead>
        <tbody>
            <tr>
              <td><span class="label label-warning arrowed-right">12pm</span></td>
              <td><?php echo h($enrolment['Enrolment']['class_two']); ?></td>
            </tr>
            <tr>
              <td><span class="label label-warning arrowed-right">3pm</span></td>
