...
/*	  		$Email->sender('admin@team-hawk.herokuapp.com', 'Hawke Meditation Centre');
	...
	public function confirmationEmail() {
		...
		foreach ($userIDS as $userID) {
			...
			$Email->send('Hello ' . $userID['User']['first_name'] . ',' . "\n\n" . 'Sending a friendly reminder that your Meditation course begins in 10 days time on the ' . $userID['Course']['start_date'] . '.' . ' If for any reason you find you can\'t attend, please notify us by email or phone call as soon as possible.' . "\n\n" . 'Thank you and we hope to see you soon!' . "\n\n" . '- The Hawke Centre Team');
