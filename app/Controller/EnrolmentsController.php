 ...
 */
	public function view($id = null) {
		...
		$options = array('conditions' => array('Enrolment.' . $this->Enrolment->primaryKey => $id, 'Student.' . $this->Enrolment->Student->primaryKey => $id, 'Course.' . $this->Enrolment->Course->primaryKey => $id));
